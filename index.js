...
//   if (jsFiles.length <= 0) return console.log('\x1b[31m', `[18] There are no commands to load from the Logging folder...`, '\x1b[0m');

//   console.log('\x1b[33m', `[18] Loading ${jsFiles.length} command(s) from the Logging folder...`, '\x1b[0m');
//   jsFiles.forEach((f, i) => {
